...
enum bpred_class {
  // -Project ///////////////////////////////////////////// Comb2Level //////
  // BPredComb2Lev: A combined branch predictor that integrates two adaptive
  // 2-level predictors. This predictor aims to enhance prediction accuracy by 
  // leveraging the strengths of both underlying predictors, effectively 
  // balancing between them based on dynamic branch behavior.
  BPredComb2Lev,		
  // -Project ///////////////////////////////////////////// Comb2Level //////
...
struct bpred_dir_t {
  ...
  // This structure is pivotal for the perceptron algorithm's learning and prediction processes.
    struct{
      ...
      signed int weight_table[400][400];	/* weight table, 2 dimensional array with an arbitrary large number to accomodate multiple scenarios */ 
...
// -Project ///////////////////////////////////////////// Comb2Level //////
    // Structs for each of the 2 level adaptive predictors
    struct bpred_dir_t *twolev_1; // 1st 2 level adaptive predictor
    struct bpred_dir_t *twolev_2; // 2nd 2 level adaptive predictor
// -Project ///////////////////////////////////////////// Comb2Level //////
...
// -Project ///////////////////////////////////////////// Comb2Level //////
// Fields 'used_twolev_1' and 'used_twolev_2': Track the usage of the two 
// individual 2-level adaptive predictors within the BPredComb2Lev predictor. 
// These fields help in analyzing the performance and contribution of each 
// predictor in the combined prediction mechanism.
  counter_t used_twolev_1;		  /* Predictor 1num 2-level predictions used (BPredComb2Lev) */
  counter_t used_twolev_2;		  /* Predictor 2 num 2-level predictions used (BPredComb2Lev) */
// -Project ///////////////////////////////////////////// Comb2Level //////
...
// -Project ///////////////////////////////////////////// Comb2Level //////
    unsigned int twolev_1   : 1;    /* 2-level predictor 1 for the combined predictor*/
    unsigned int twolev_2   : 1;    /* 2-level predictor 2 for the combined predictor*/
// -Project ///////////////////////////////////////////// Comb2Level //////
...
// -Project ///////////////////////////////////////////// Comb2Level //////
// Function 'bpred_create_BPredComb2Level': Instantiates the combined two-level
// adaptive branch predictor (BPredComb2Lev). This function initializes and 
// configures the two individual 2-level predictors and the meta predictor, 
// setting up the combined predictor for operation.
